<template>
    <div style="text-align: center">
        <el-form :model="recruitmentInfo" :rules="recruitmentInfoRules" ref="recruitmentInfoForm"
            ...
            <el-form-item label="实验分期：" prop="practiceStages">
                <el-input v-model="recruitmentInfo.practiceStages" placeholder="实验分期"></el-input>
            </el-form-item>
            ...
            <el-form-item label="招募人数：" prop="recruitmentNumber">
                <el-input v-model.number="recruitmentInfo.recruitmentNumber" placeholder="招募人数"></el-input>
            </el-form-item>
            ...
            <el-form-item>
                <el-button type="primary" @click="onAddRecruitmentAction('recruitmentInfoForm')">提交
                </el-button>
            </el-form-item>
        </el-form>
    </div>
