...
<jsp:include page="../components/navbar-pc.jsp">
    ...
    <jsp:param value="patientAdd" name="menuAction"/>
</jsp:include>
<div class="sui-container">
    ...
    <form id="addPatientForm" class="sui-form form-horizontal" novalidate="novalidate">
        ...
        <div class="control-group patient-address">
...
<script type="text/javascript" src="/static/js/patient/add-pc.js?_v=${version}"></script>
</html>